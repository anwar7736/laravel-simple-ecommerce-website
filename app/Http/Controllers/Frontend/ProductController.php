...
class ProductController extends Controller
{
    public function index(Request $request){
        if ($request->ajax()) {
            ...
            $items=$query->groupBy('products.id','products.name','products.type','products.purchase_price','products.regular_price','products.sell_price','products.image','is_stock','products.discount','products.discount_type','products.category_id','products.after_discount','products.dicount_amount')
            ->paginate(30);
    ...
    public function show($id)
    {
  	...
  	public function relativeProduct($id){
        ...
        $products=Product::with('variation')
                ...
                ->select('products.id','products.name','products.type','products.purchase_price','products.regular_price','products.sell_price','products.image','is_stock','products.category_id','products.discount_type','products.discount','products.after_discount','products.dicount_amount')
