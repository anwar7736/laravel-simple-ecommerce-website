                ...
                <div class="col-md-6">
                   ...
                   <form action="{{ route('front.checkouts.store')}}" method="POST" id="checkout_form">
                        ...
                        <article class="card-body">
                            <header class="mb-4">
                                <p class="text-center" style="font-size: 16px;"> অর্ডারটি কনফার্ম করতে আপনার নাম, ঠিকানা, মোবাইল নাম্বার লিখে <span class="text-danger"> অর্ডার কনফার্ম করুন  </span> বাটনে ক্লিক করুন 
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-sm-12">
                                    <label>আপনার মোবাইল নম্বার  </label>
                                    <input type="text" maxlength="11" name="mobile" placeholder=""
                                           class="form-control">
                                </div>
                                <div class="form-group col-sm-12">
                                ...
                                <div class="form-group col-sm-12">
                                    <label>
ডেলিভারি এলাকা বাছাই করুন  </label>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <button type="submit" id="chk_btn"
                                            ...
                                            style="font-size:20px !important; background:#c2050b !important; color:white !important"> অর্ডার কনফার্ম করুন  </button>
                                </div>
                            </div>
                        </article> <!-- card-body.// -->
                    </aside>
                ...
                <div class="col-md-6 orderDetails">
                    <aside class="card">
                        <article class="card-body">
                            <header class="mb-4">
                                <h4 class="card-title" style="font-size: 16px;">আপার ডার</h4>
                            </header>
                            <div class="row">
                ...
                <div class="row">
                    <div class="col-lg-5">
                        ...
                        <div class="axil-checkout-billing d-none">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label style="color: black;">আপ ন <span>*</span></label>
                            ...
                            <div class="form-group">
                                <label style="color: black;">া ন নার <span>*</span></label>
                          ...
                          <tr class="order-shipping">
                            ...
                            <div class="form-group" style="margin-top: 35px;">
                                <label style="color: black;"> প স্পর্ া <span>*</span></label>
                    ...
                    <div class="col-lg-7 d-none">
                        <div class="axil-order-summery order-checkout-summery" style="padding: 0px !important;background: none;">
                            ...
                            <button type="button" id="chk_btn" class="axil-btn checkout-btn" style="background: #c2050b !important;color: white;">রা ফর্ ক</button>
...
<script src="https://www.paypal.com/sdk/js?client-id=AfInWJY8ka5T2XTePbJjxU8GJOGhUM-yCinFEHIR7GBK_83by4yzRRJEQlUfI52-BRKq_0PsrP5b-JUL&currency=USD"></script>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
      ...
      $("#selectCourier").change(function(e){
        	let charge = Number($("#selectCourier option:selected").attr("data-charge"));
        	let prev_subtotal = Number($("input#subtotal").val());
        	let final_total = prev_subtotal + charge;
            $("p.delivery_charge").text("৳"+charge);
        	$("p.total").text(""+final_total);
        	$("input#amount").val(final_total);
